...
<div class="layui-col-md12">
    <form class="layui-form" action="" method="post">
        ...
        <div class="layui-form-item layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="am_status" value="1" lay-skin="switch" <?php if ($info['am_status'] == 1) { ?>checked<?php } ?> lay-text="正常|关停">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['element','jquery','layer','form'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.post('index.php?c=system&a=edit',data.field,function (data) {
                if(data.status == 1){
                    layer.close(index);
                    layer.msg(data.msg,{
                        time: 3000,
