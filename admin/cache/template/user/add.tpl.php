    ...
    <form class="layui-form" action="" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="us_phone" value="" lay-verify="required" class="layui-input" type="text">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="us_name" value="" class="layui-input" type="text">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">初始积分</label>
            <div class="layui-input-inline">
                <input name="us_point" value="0" lay-verify="required" class="layui-input" type="text">
            </div>
            <div class="layui-form-mid layui-word-aux">必填</div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="checkbox" name="us_status" value="1" lay-skin="switch" checked lay-text="正常|关停">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(['element','jquery','layer','form'], function(){
        ...
        form.on('submit(demo1)', function(data){
            ...
            $.post('index.php?c=user&a=add',data.field,function (data) {
                if(data.status == 1){
                    layer.close(index);
                    layer.msg(data.msg,{
                        time: 3000,
